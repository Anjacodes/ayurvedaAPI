...
ActiveRecord::Schema[7.0].define(version: 2022_06_01_223913) do
  ...
  create_table "dosha_foods", force: :cascade do |t|
    t.bigint "dosha_id", null: false
    t.bigint "food_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["dosha_id"], name: "index_dosha_foods_on_dosha_id"
